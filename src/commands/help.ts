...
const PAGES: HelpPage[] = [
  ...
  {
    title: '/monitor — social media author monitoring',
    description: [
      'Tracks authors (Twitter/X and Pixiv) and relays their posts/artworks to a target channel.',
      '',
      '• `add <username|pixiv-id> [platform=pixiv]` — start monitoring an author',
      ...
      '• `fixers <domains> [platform]` — set the fixer domain order (X: e.g. `fixupx.com` `fxtwitter.com`; pixiv: `www.phixiv.net`)',
      ...
      '• `await <value> <seconds|minutes>` — wait for a tweet or pixiv link, then auto-add its author (default `5 minutes`)',
    ].join('\n'),
  },
  {
